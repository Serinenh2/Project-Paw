...
$stmt = $pdo->query("SELECT id, fullname, email FROM users WHERE role='professor'");
...
<body>
  ...
  <div class="main">
    ...
    <table>
      <thead><tr><th>ID</th><th>Fullname</th><th>Email</th><th>Actions</th></tr></thead>
      <tbody>
        <?php foreach($professors as $p): ?>
          <tr>
            ...
            <td class="actions">
              <a href="edit_professor.php?id=<?= $p['id'] ?>" class="edit">Edit</a>
              <a href="delete_professor.php?id=<?= $p['id'] ?>" class="delete" onclick="return confirm('Delete this professor?')">Delete</a>
            </td>
          </tr>
        <?php endforeach; ?>
      </tbody>
